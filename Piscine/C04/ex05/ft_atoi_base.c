...
/*   Updated: 2022/02/15 20:58:58 by minkyeki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

unsigned int	get_base_size_1(char *base)
{
	int	size;
...
int	has_base(char *str, char *base)
{
	while (*base)
	{
		if (*str == *base)
...
int	find_base_index_1(char target, char *base)
{
	int	index;
