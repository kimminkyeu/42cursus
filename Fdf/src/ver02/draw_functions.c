...
/*   Updated: 2022/04/27 22:55:41 by minkyeki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* ----------------------------------------------
 * * */
static void bresenham_cliplot(t_mlx *data, t_vector3 ctr, t_vector3 p)
{
...
void bresenham_circle(t_mlx *data, t_vector3 p1, int radius)
{
	t_vector3	p2;
	int		p;
...
void	draw_wired_circle_on_image3(t_mlx *data, t_vector3 _pos, float radius)
{
	bresenham_circle(data, _pos, radius);
}
