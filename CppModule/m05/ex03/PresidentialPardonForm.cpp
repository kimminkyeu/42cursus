...
PresidentialPardonForm::PresidentialPardonForm()
	:Form("Presidential Pardon", _requiredGradeToSign, _requiredGradeToExecute), _target("NoTarget")
{
...
PresidentialPardonForm::PresidentialPardonForm(const std::string &target)
	:Form("Presidential Pardon", _requiredGradeToSign, _requiredGradeToExecute), _target(target)
{
...
{
	std::cout << "PresidentialPardonForm std::string name+target constructor called\n";
}
