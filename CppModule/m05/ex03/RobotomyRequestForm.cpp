...
RobotomyRequestForm::RobotomyRequestForm()
	:Form("Robotomy Request", _requiredGradeToSign, _requiredGradeToExecute), _target("NoTarget")
{
...
RobotomyRequestForm::RobotomyRequestForm(const std::string &target)
	:Form("Robotomy Request", _requiredGradeToSign, _requiredGradeToExecute), _target(target)
{
...
{
	std::cout << "RobotomyRequestForm std::string name+target constructor called\n";
}
